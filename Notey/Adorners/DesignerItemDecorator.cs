namespace CanvasUie
{
    ...
    public class DesignerItemDecorator : Control
    {
        ...
        public static readonly DependencyProperty ShowDecoratorProperty =
            ...
            new FrameworkPropertyMetadata(false, new PropertyChangedCallback(ShowDecoratorPropertyChanged)));

        public DesignerItemDecorator()
        {
            Unloaded += new RoutedEventHandler(this.DesignerItemDecoratorUnloaded);
        }
        ...
        private void DesignerItemDecoratorUnloaded(object sender, RoutedEventArgs e)
        {
            if (this.adorner != null)
            {
                AdornerLayer adornerLayer = AdornerLayer.GetAdornerLayer(this);
